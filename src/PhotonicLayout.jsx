...
function parseAnchor(anchorName) {
...
function anchorLocal(anchorName, w, h) {
...
function anchorWorld(comp, anchorName, paramValues) {
...
function rectInstanceToRing(inst) {
...
// into a ring of [x, y] world-space points that traces its perimeter. This
// uniformly handles rotation via the `rotation` field (degrees, CCW).
//
...
function shapeInstanceToRing(inst) {
...
function eulerBend180Centerline(R, p, nPts = 128) {
...
function buildRacetrackCenterline(R, L_straight, p, nPtsBend = 128) {
...
function offsetCenterlineToBand(centerline, halfW) {
